...
func TestProofTypes(t *testing.T) {
	...
	assert.EqualValues(t, generated.FilRegisteredPoStProofStackedDrgWinning16GiBV1, abi.RegisteredPoStProof_StackedDrgWinning16GiBV1)
	assert.EqualValues(t, generated.FilRegisteredPoStProofStackedDrgWinning4GiBV1, abi.RegisteredPoStProof_StackedDrgWinning4GiBV1)
	...
	assert.EqualValues(t, generated.FilRegisteredPoStProofStackedDrgWindow16GiBV1, abi.RegisteredPoStProof_StackedDrgWindow16GiBV1)
	assert.EqualValues(t, generated.FilRegisteredPoStProofStackedDrgWindow4GiBV1, abi.RegisteredPoStProof_StackedDrgWindow4GiBV1)
	...
	assert.EqualValues(t, generated.FilRegisteredSealProofStackedDrg16GiBV1, abi.RegisteredSealProof_StackedDrg16GiBV1)
	assert.EqualValues(t, generated.FilRegisteredSealProofStackedDrg4GiBV1, abi.RegisteredSealProof_StackedDrg4GiBV1)
}
